...
ALLOWED_HOSTS = ['govector.herokuapp.com', 'localhost']
...
#STATIC_URL = os.path.join(BASE_DIR, '/condominios/static/')
#STATIC_ROOT = os.path.join(BASE_DIR, 'condominios/../condominios/static')
